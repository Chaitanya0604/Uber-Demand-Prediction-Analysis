...
if __name__ == "__main__":
    ...
    # data_path
    data_path = root_path / "data/processed/dvc_resampled_data.csv"
    ...
    train_data_save_path = root_path / "data/processed/dvc_train.csv"
    test_data_save_path = root_path / "data/processed/dvc_test.csv"
